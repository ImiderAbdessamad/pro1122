...
import java.util.List;
@Service
public class InscriptionCollaboratorStateAgentServiceImpl implements InscriptionCollaboratorStateAgentService {
    ...
    public InscriptionCollaboratorStateAgentServiceImpl(InscriptionCollaboratorStateDao dao) {
        this.dao = dao;
    }
