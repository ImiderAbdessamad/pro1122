...
public class InscriptionCollaboratorStateRestCollaborator {
   ...
   public InscriptionCollaboratorStateRestCollaborator(InscriptionCollaboratorStateCollaboratorService service, InscriptionCollaboratorStateConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final InscriptionCollaboratorStateCollaboratorService service;
    private final InscriptionCollaboratorStateConverter converter;
