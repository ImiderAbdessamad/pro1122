...
import ma.zs.zyn.service.impl.admin.inscription.InscriptionCollaboratorStateAdminServiceImpl;
import ma.zs.zyn.ws.facade.admin.inscription.InscriptionCollaboratorStateRestAdmin;
...
public class InscriptionCollaboratorStateRestAdminTest {

    private MockMvc mockMvc;

    @Mock
    private InscriptionCollaboratorStateAdminServiceImpl service;
    @Mock
    private InscriptionCollaboratorStateConverter converter;

    @InjectMocks
    private InscriptionCollaboratorStateRestAdmin controller;
