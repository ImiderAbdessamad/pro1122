...
export class InscriptionCollaboratorListCollaboratorComponent implements OnInit {
    ...
    constructor( private service: InscriptionCollaboratorCollaboratorService  , private collaboratorService: CollaboratorCollaboratorService, private packagingPlanService: PackagingPlanCollaboratorService, private inscriptionCollaboratorStateService: InscriptionCollaboratorStateCollaboratorService, @Inject(PLATFORM_ID) private platformId?) {
...
// add
    ...
    public initCol() {
        this.cols = [
            ...
            {field: 'inscriptionCollaboratorState?.libelle', header: 'Inscription collaborator state'},
        ];
    }
   ...
   public prepareColumnExport(): void {
        this.exportData = this.items.map(e => {
            return {
                ...
                'Inscription collaborator state': e.inscriptionCollaboratorState?.libelle ,
            }
        });
        ...
        //'Inscription collaborator state': this.criteria.inscriptionCollaboratorState?.libelle ? this.criteria.inscriptionCollaboratorState?.libelle : environment.emptyForExport ,
        }];
      }
