...
export class InscriptionCollaboratorViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: InscriptionCollaboratorCollaboratorService, private collaboratorService: CollaboratorCollaboratorService, private packagingPlanService: PackagingPlanCollaboratorService, private inscriptionCollaboratorStateService: InscriptionCollaboratorStateCollaboratorService){
