...
export class InscriptionCollaboratorStateCreateCollaboratorComponent  implements OnInit {
   ...
   private _validInscriptionCollaboratorStateLibelle = true;
    ...
    public  setValidation(value: boolean){
        ...
        this.validInscriptionCollaboratorStateLibelle = value;
    }
    ...
    public  validateForm(): void{
        ...
        this.validateInscriptionCollaboratorStateLibelle();
    }
    ...
    public validateInscriptionCollaboratorStateLibelle(){
        if (this.stringUtilService.isEmpty(this.item.libelle)) {
        this.errorMessages.push('Libelle non valide');
        this.validInscriptionCollaboratorStateLibelle = false;
        } else {
            this.validInscriptionCollaboratorStateLibelle = true;
        }
    }
