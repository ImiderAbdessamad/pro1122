...
@Component({
  selector: 'app-inscription-collaborator-state-view-admin',
  templateUrl: './inscription-collaborator-state-view-admin.component.html'
})
export class InscriptionCollaboratorStateViewAdminComponent implements OnInit {
    ...
    constructor(private service: InscriptionCollaboratorStateAdminService){
