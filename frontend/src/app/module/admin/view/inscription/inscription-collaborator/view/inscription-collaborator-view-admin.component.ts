...
export class InscriptionCollaboratorViewAdminComponent implements OnInit {
    ...
    constructor(private service: InscriptionCollaboratorAdminService, private collaboratorService: CollaboratorAdminService, private packagingPlanService: PackagingPlanAdminService, private inscriptionCollaboratorStateService: InscriptionCollaboratorStateAdminService){
